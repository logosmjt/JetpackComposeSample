...
dependencies {
    ...
    implementation( "androidx.room:room-runtime:${LibraryVersions.roomVersion}")
    implementation( "androidx.room:room-ktx:${LibraryVersions.roomVersion}")
    kapt ("androidx.room:room-compiler:${LibraryVersions.roomVersion}")
